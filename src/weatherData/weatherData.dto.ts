...
export enum WeatherDescription {
  ...
  Drizzle = 'Use an umbrella or raincoat',
  Snow = 'Drive carefully and wear warm clothing',
  Mist = 'Exercise caution while driving',
  Smoke = 'Limit outdoor activities and stay indoors',
  Haze = 'Use headlights and reduce driving speed',
  Dust = 'Wear masks outdoors and keep windows closed',
  Fog = 'Use low-beam headlights when driving',
  Sand = 'Wear protective eyewear and avoid outdoor activities',
  ...
  Clouds = 'Expect changing weather throughout the day',
}
